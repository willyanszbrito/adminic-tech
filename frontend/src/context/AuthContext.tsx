...
const STORAGE_USER_KEY = 'adminic_auth_user';
const STORAGE_TOKEN_KEY = 'adminic_auth_token';
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const googleClientId = import.meta.env.VITE_GOOGLE_CLIENT_ID || '564423794141-eum30ivtuprbv8ikk8qi6b7gapgm6a2v.apps.googleusercontent.com';
