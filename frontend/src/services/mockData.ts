    ...
    services: [
      {
        ...
        name: 'Corte',
        description: 'Corte masculino clássico ou degradê moderno com acabamento navalhado.',
        duration_minutes: 30,
        price: 30.0,
      ...
      },
      {
        ...
        category_id: 'cat-campelo-barba',
        name: 'Pigmentação',
        description: 'Pigmentação suave para realce do desenho capilar e barba.',
        duration_minutes: 15,
        price: 5.0,
        image_url: '/logos/logo_campelo.jpg',
        is_featured: false,
      ...
      },
      {
        ...
        name: 'Corte Completo, Lavagem e Hidratação',
        description: 'Combo completo: corte de cabelo estilizado, lavatório refrescante e hidratação capilar.',
        duration_minutes: 60,
        price: 70.0,
        image_url: '/logos/logo_campelo.jpg',
        is_featured: true,
