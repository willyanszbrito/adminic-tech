...
ALL_SEED_TENANTS = [TENANT_CAMPELO, TENANT_SEGREDOS, TENANT_BARBER, TENANT_CLINIC, TENANT_BEAUTY, TENANT_AUTO]
ALL_SEED_CATEGORIES = CATEGORIES_CAMPELO + CATEGORIES_SEGREDOS + CATEGORIES_BARBER + CATEGORIES_CLINIC + CATEGORIES_BEAUTY + CATEGORIES_AUTO
ALL_SEED_SERVICES = SERVICES_CAMPELO + SERVICES_SEGREDOS + SERVICES_BARBER + SERVICES_CLINIC + SERVICES_BEAUTY + SERVICES_AUTO
ALL_SEED_STAFF = STAFF_CAMPELO + STAFF_SEGREDOS + STAFF_BARBER + STAFF_CLINIC + STAFF_BEAUTY + STAFF_AUTO
